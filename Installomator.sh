...
microsoftteamsnew)
    ...
    appNewVersion=$(curl -fsL "https://officecdnmac.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/0409TEAMS21.xml" | xmllint --xpath '//array/dict[1]/key[text()="Title"]/following-sibling::string[1]/text()' - | grep -oE '[0-9]+\.[0-9]+\.[0-9]+' 2>/dev/null)
    expectedTeamID="UBF8T346G9"
...
teamviewer)
    ...
    appNewVersion=$(curl -fsL "https://www.teamviewer.com/en/download/macos/" | grep "Current version" | awk -F': ' '{ print $2 }' | sed 's/<[^>]*>//g')
